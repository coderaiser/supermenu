var MenuIO,Util;!function(e){"use strict";function t(){function e(e){var t;return e&&(t=n(e),t&&(e=e.parentElement)),e}function t(e){var t;return e&&(t=n(e),t||(e=e.querySelector("[data-menu-path]"))),e}function n(e){var t;return e&&(t=e.hasAttribute("data-menu-path")),t}function i(e){var t=a(e,"js-menu-item");return t}function u(e){var t=a(e,"js-menu");return t}function a(e,t,n){var i,u;return n||(n="data-name"),e&&(u=e.getAttribute(n),u===t&&(i=!0)),i}function r(t){var n,i,u="data-menu",r="js-submenu";return i=e(t),n=a(i,r,u)}this.getItem=e,this.getName=t,this.isName=n,this.isItem=i,this.isMenu=u,this.isSubMenu=r}MenuIO=function(n,i,u){function a(){var e,t=Util.isObject(u);t||(e=u,u={},u[e]=null),h=r(u),I.addEventListener("click",m),I.addEventListener("contextmenu",c)}function r(e){var t,n="",i=function(e,t){var n='data-menu="js-submenu"',u="";return t?t+=".":t="",Object.keys(e).forEach(function(a){var r,s="",m="",c="",l=t+a,o=e[a],d=Util.isObject(o);d?(s=Util.render(g.MAIN,{items:i(o,l)}),m=" menu-submenu",c=" "+n):U[l]=o,M.icon&&(r=Util.convertName(a),m+=" icon icon-"+r),u+=Util.render(g.ITEM,{name:a,subitems:s,className:m,attribute:c,path:l})}),u};return n=i(e),t=document.createElement("ul"),t.setAttribute("data-name","js-menu"),t.className="menu menu-hidden",t.innerHTML=n,v.appendChild(t),t}function s(e,t){var n,i=N.getItem(e),u=N.isName(i),a=N.isItem(i),r=N.isSubMenu(i);return u&&a||(i=document.elementFromPoint(t.x,t.y),r=N.isSubMenu(i),u=N.isName(i),a=N.isItem(i)),n={name:u,item:a,sub:r}}function m(e,t){var n,i,u=M.beforeClick,a=M.name,r=e.target,m=t||s(r,{x:e.clientX,y:e.clientY});i=Util.exec(u,a),m.sub?e.preventDefault():(d(),i||!m.name&&!m.item||(n=f(r),Util.exec(n)))}function c(e){var t=e.target,n=e.clientX,i=e.clientY,u=s(t,{x:n,y:i});u.name||u.item||u.sub?m(e,u):(d(),o(n,i)),e.preventDefault()}function l(t,n){var i=Util.isNumber(t),u=Util.isNumber(n),a=b(),r=e.innerHeight;a+n>r&&(n-=a),i&&(h.style.left=t+"px"),u&&(h.style.top=n-15+"px")}function o(e,t){var n=M.beforeShow,i=M.name,u=Util.exec(n,e,t,i);u||(h.classList.remove("menu-hidden"),l(e,t))}function d(){var e=Util.exec(M.beforeClose);e||h.classList.add("menu-hidden")}function f(e){var t,n;return e=N.getName(e),e&&(t=e.getAttribute("data-menu-path")),n=U[t]}function b(){var e,t;return p||(e=getComputedStyle(h),t=e.height,p=parseInt(t,10)),p}if(!(this instanceof MenuIO))return new MenuIO(n,i,u);var h,v,p,I,M={},N=new t,U={},g={MAIN:'<ul data-name="js-menu" class="menu menu-hidden">{{ items }}</ul>',ITEM:'<li data-name="js-menu-item" class="menu-item{{ className }}"{{ attribute }}><label data-menu-path="{{ path }}">{{ name }}</label>{{ subitems }}</li>'};u?(v=I=n,M=i):i?(v=I=n,u=i):(v=document.body,I=e,u=n),this.show=o,this.hide=d,a()}}(window);
